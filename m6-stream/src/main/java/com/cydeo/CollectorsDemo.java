...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        //joining(): is used to join the various elements of a character or string array into a single object
        ...
        //groupingBy(): is used for grouping pbjects by some property and storing results in a Map instance
